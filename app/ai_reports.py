...
def interpret(text: str, provider_name: str, model: str, api_key: str,
              base_url: str = "", roster: list[dict] | None = None,
              year: str = "Y8", default_dates: list[str] | None = None) -> dict:
    ...
    full_text = (user_intro + "\n\n" + text).strip() if user_intro else text
    raw = provider.chat_json(system, full_text, model)
